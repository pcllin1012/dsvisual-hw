(function () {
    ...
    let TRANSLATIONS = {
        en: {
            ...
            'method.graph-boruvka':         'Borůvka MST',
            'method.graph-redblue':         'Red-Blue Rules (MST)',
            ...
            'method.recursion': 'Recursion (Call Tree & Stack)',
            'method.file-isam': 'ISAM (Indexed Sequential)',
            'method.file-inverted': 'Inverted Index',
            'method.sort-polyphase': 'Polyphase Merge (Tapes)',
            'method.matrix-sparse': 'Sparse Matrix (Transpose)',
            'method.matrix-sparse-list': 'Sparse Matrix (Linked List)',
            ...
            'lab.dsjudgePractice': 'Practice on dsjudge', 'lab.dsjudgeSignin': 'Sign in to practice on dsjudge',
        ...
        zh: {
            ...
            'method.recursion': '遞迴(呼叫樹與堆疊)',
            'method.file-isam': 'ISAM 索引循序',
            'method.file-inverted': '倒排索引',
            'method.sort-polyphase': 'Polyphase 磁帶合併',
            'method.matrix-sparse': '稀疏矩陣(轉置)',
            'method.matrix-sparse-list': '稀疏矩陣(鏈結串列)',
            ...
            'lab.dsjudgePractice': '到 dsjudge 練習', 'lab.dsjudgeSignin': '登入後到 dsjudge 練習',
