...
const codeGraphMultilist = `#include <iostream>
using namespace std;
...
const codeGraphBoruvka = `#include <iostream>
#include <vector>
#include <algorithm>
using namespace std;
...
const codeGraphRedblue = `#include <iostream>
#include <vector>
#include <algorithm>
using namespace std;
...
const codeGraphMatrix = `#include <iostream>
using namespace std;
...
const codeGraphComponents = `#include <iostream>
#include <queue>
#include <vector>
using namespace std;
...
const codeGraphBipartite = `#include <iostream>
#include <queue>
#include <vector>
using namespace std;
...
const codeGraphClosure = `#include <iostream>
using namespace std;
...
const codeGraphScc = `#include <iostream>
#include <vector>
#include <stack>
using namespace std;
...
const codeMatrixSparseList = `// Sparse matrix as an orthogonal (row + column) linked list, with transpose.
#include <iostream>
#include <vector>
using namespace std;
...
const codeMagicLatin = `// Why the Siamese magic square works: every value splits as v = n*a + b + 1,
...
const codeMagicTorus = `// Siamese magic square, viewed as a walk on a torus: the board wraps mod n,
...
const codeMagicSymmetry = `// The 8 symmetries of a square form the dihedral group D4 (4 rotations +
...
const codeListEquivalence = `// Equivalence classes via linked-list adjacency (Horowitz) + stack traversal
#include <iostream>
#include <vector>
#include <stack>
using namespace std;
...
const codeTreeExpression = `#include <stack>
#include <string>
#include <sstream>
#include <cctype>
#include <iostream>
...
const codeTreeReconstruct = `#include <iostream>
#include <vector>
#include <string>
#include <unordered_map>
#include <functional>
...
const codeTreeArrayRep = `#include <iostream>
#include <vector>
#include <string>
#include <sstream>
...
const codeTreeCatalan = `#include <iostream>
#include <vector>
#include <cstdint>
...
const codeTreeCopyEqual = `#include <iostream>
#include <string>
...
const codeDecisionTreeCoins = `#include <iostream>
#include <array>
...
const codeLruCache = `#include <iostream>
#include <list>
#include <unordered_map>
using namespace std;
...
const codeQuickselect = `#include <vector>
#include <algorithm>
...
const CODE_DB = {
    ...
    "graph_redblue.cpp": codeGraphRedblue,
